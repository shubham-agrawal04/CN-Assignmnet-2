...
def task_c(scenario, net, cc_scheme):
    """
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="Mininet TCP Congestion Control Task C")
